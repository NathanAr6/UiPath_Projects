...
namespace AutoEmail
{
    ...
    {
        private Lazy<global::AutoEmail.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::AutoEmail.WorkflowRunnerService>(() => new global::AutoEmail.WorkflowRunnerService(this.RunWorkflow));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::AutoEmail.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
